...
//
// On Sun Oct 26 20:49:03 IST 2025
//
//
// Ports:
// Name                         I/O  size props
...
module mkstage2(CLK,
  ...
  assign alu_inputs_op1 =
	     rx_stage1_meta_first_x[49] ?
	       rx_stage1_control_first_x[63:0] :
	       op1__h3086 ;
  assign alu_inputs_op2 = _op2__h3089 ;
  always@(rx_stage1_meta_first_x or rx_stage1_control_first_x or op1__h3086)
  begin
    case (rx_stage1_meta_first_x[46:43])
      4'd1, 4'd4: alu_inputs_op3 = op1__h3086;
  ...
  begin
    case (rx_stage1_meta_first_x[48:47])
      2'd0: _op2__h3089 = op2__h3087;
      2'd1:
	  _op2__h3089 =
	      SEXT_IF_ff_stage1_meta_w_data_whas__0_THEN_ff__ETC___d227;
      2'd2: _op2__h3089 = 64'd4;
      2'd3: _op2__h3089 = 64'd2;
    endcase
  end
...
//0;
 ...
 //ignore unusedbits 
(* keep = "true" *) wire unused_rx_stage1_meta_first_x;
assign unused_rx_stage1_meta_first_x = |rx_stage1_meta_first_x;
