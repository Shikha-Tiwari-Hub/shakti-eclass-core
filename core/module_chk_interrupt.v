...
//
// On Sun Oct 26 20:48:41 IST 2025
//
//
// Ports:
// Name                         I/O  size props
...
//ignore unusedbits
// Consume unused bits to avoid ASSIGN-10 lint warnings
(* keep = "true" *)wire unused_chk_interrupt_mip;
assign unused_chk_interrupt_mip = |chk_interrupt_mip[13:12];

(* keep = "true" *)wire unused_chk_interrupt_mstatus;
assign unused_chk_interrupt_mstatus = |chk_interrupt_mstatus[63:1];
